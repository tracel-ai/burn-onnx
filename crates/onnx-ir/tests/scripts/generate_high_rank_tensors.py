...
def create_model():
    input_5d = helper.make_tensor_value_info(
        "input_5d", TensorProto.FLOAT, [2, 3, 4, 5, 6]
    )
    input_6d = helper.make_tensor_value_info(
        "input_6d", TensorProto.FLOAT, [1, 2, 3, 4, 5, 6]
    )
