...
mod tests {
    ...
    fn linear() {
        ...
        let model: linear::Model = linear::Model::default();
        #[allow(clippy::approx_constant)]
        let input1 = Tensor::<2>::full([4, 3], 3.14, &device);
        #[allow(clippy::approx_constant)]
        let input2 = Tensor::<2>::full([2, 5], 3.14, &device);
        #[allow(clippy::approx_constant)]
        let input3 = Tensor::<3>::full([3, 2, 7], 3.14, &device);
        ...
        let output_sum1 = output1.sum().into_scalar::<f32>();
        let output_sum2 = output2.sum().into_scalar::<f32>();
        let output_sum3 = output3.sum().into_scalar::<f32>();
