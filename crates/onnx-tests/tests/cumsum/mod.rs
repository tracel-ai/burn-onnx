...
mod tests {
    ...
    fn cumsum_default() {
        ...
        let model: cumsum::Model = cumsum::Model::default();

        let input = Tensor::<1>::from_floats([1., 2., 3., 4., 5.], &device);
    ...
    fn cumsum_exclusive_mode() {
        ...
        let device = Default::default();
        let model: cumsum_exclusive::Model = cumsum_exclusive::Model::default();
    ...
    fn cumsum_reverse_mode() {
        ...
        let device = Default::default();
        let model: cumsum_reverse::Model = cumsum_reverse::Model::default();
    ...
    fn cumsum_exclusive_reverse_mode() {
        ...
        let device = Default::default();
        let model: cumsum_exclusive_reverse::Model = cumsum_exclusive_reverse::Model::default();
    ...
    fn cumsum_2d_axis_1() {
        ...
        let device = Default::default();
        let model: cumsum_2d::Model = cumsum_2d::Model::default();
    ...
    fn cumsum_runtime_axis_test() {
        ...
        // Expected output (2D, axis=1): [[1., 3., 6.], [4., 9., 15.]]
        let device = Default::default();
        let model: cumsum_runtime_axis::Model = cumsum_runtime_axis::Model::default();
    ...
    fn cumsum_single_element_test() {
        ...
        // Expected output: [42.]
        let device = Default::default();
        let model: cumsum_single_element::Model = cumsum_single_element::Model::default();

        let input = Tensor::<1>::from_floats([42.], &device);
        let output = model.forward(input);
    ...
    fn cumsum_exclusive_single_element_test() {
        ...
        let device = Default::default();
        let model: cumsum_exclusive_single::Model = cumsum_exclusive_single::Model::default();
