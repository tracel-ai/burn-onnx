...
# Generates: gru_runtime_weights.onnx
# GRU whose W/R/B arrive as graph inputs rather than initializers, the shape every
...
def main():
    ...
    graph = helper.make_graph([gru_node], "gru_runtime_weights_graph", [inp, w, r, b], [out_Y, out_Y_h])
    ...
    onnx.save(model, "gru_runtime_weights.onnx")
    print("Saved gru_runtime_weights.onnx")
