...
# used to generate model: onnx-tests/tests/equal/equal_shape_rank_lift.onnx
#
...
def main():
    ...
    nodes = [
        ...
        helper.make_node("Equal", ["x", "dim0"], ["tensor_shape"]),
        helper.make_node("Equal", ["dim0", "x"], ["shape_tensor"]),
    ]
    graph = helper.make_graph(
        nodes, "equal_shape_rank_lift", [x], [out1, out2], initializer=[idx]
    )
    ...
    onnx_name = "equal_shape_rank_lift.onnx"
