...
def main():
    node0 = helper.make_node(
        "GlobalAveragePool", ["onnx::GlobalAveragePool_0"], ["2"])
    node1 = helper.make_node(
        "GlobalAveragePool", ["input"], ["3"])

    inp_onnx__GlobalAveragePool_0 = helper.make_tensor_value_info("onnx::GlobalAveragePool_0", TensorProto.FLOAT, [2, 4, 10])
    inp_input = helper.make_tensor_value_info("input", TensorProto.FLOAT, [3, 10, 3, 15])
