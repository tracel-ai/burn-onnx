...
mod tests {
    ...
    fn expand() {
        ...
        let model: expand::Model = expand::Model::new(&device);

        let input1 = Tensor::<2>::from_floats([[-1.0], [1.0]], &device);
    ...
    fn expand_tensor() {
        let device = Default::default();
        let model: expand_tensor::Model = expand_tensor::Model::new(&device);

        let input1 = Tensor::<2>::from_floats([[-1.0], [1.0]], &device);
        let input2 = Tensor::<1, Int>::from_ints([2, 2], &device);
    ...
    fn expand_scalar() {
        let device = Default::default();
        let model: expand_scalar::Model = expand_scalar::Model::new(&device);

        let input = 5i64;
        let shape = Tensor::<1, Int>::from_ints([2, 2], &device);
    ...
    fn expand_shape() {
        let device = Default::default();
        let model: expand_shape::Model = expand_shape::Model::new(&device);

        let input1 = Tensor::<2>::from_floats([[-1.0], [1.0], [1.0], [1.0]], &device);
        let input2 = Tensor::<2>::zeros([4, 4], &device);
    ...
    fn expand_with_where_shape() {
        ...
        let model: expand_with_where_shape::Model = expand_with_where_shape::Model::default();

        // Input tensor to be expanded
        let input = Tensor::<3>::ones([1, 1, 4], &device);
    ...
    fn expand_dynamic_where() {
        ...
        let device = Default::default();
        let model: expand_dynamic_where::Model = expand_dynamic_where::Model::new(&device);

        let input_data = Tensor::<1>::from_floats([10.0, 20.0, 30.0], &device);
        let input_flag = true;
    ...
    fn expand_shape_as_data() {
        ...
        let device = Default::default();
        let model: expand_shape_as_data::Model = expand_shape_as_data::Model::new(&device);
    ...
    fn expand_max_semantics() {
        ...
        let device = Default::default();
        let model: expand_max_semantics::Model = expand_max_semantics::Model::new(&device);
