...
# used to generate model: and.onnx
...
def main():
    ...
    node2 = helper.make_node("And", ["/Cast_output_0", "/Cast_1_output_0"], ["4"])
    ...
    onnx.save(model, "and.onnx")
    print(f"Finished exporting model to and.onnx")
