...
def main():
    node0 = helper.make_node(
        ...
        value=numpy_helper.from_array(np.array([3], dtype=np.int64).reshape([1]), name="value"))
    ...
    inp_onnx__Unsqueeze_0 = helper.make_tensor_value_info("onnx::Unsqueeze_0", TensorProto.FLOAT, [3, 4, 5])
