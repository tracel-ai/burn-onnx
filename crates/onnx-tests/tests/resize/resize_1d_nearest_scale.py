...
# used to generate model: resize_1d_nearest_scale.onnx
...
def main():
    ...
    onnx.save(model, "resize_1d_nearest_scale.onnx")
    print(f"Finished exporting model to resize_1d_nearest_scale.onnx")
