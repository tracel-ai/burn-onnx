...
# used to generate model: onnx-tests/tests/greater_or_equal/greater_or_equal_shape_rank_lift.onnx
#
...
def main():
    ...
    nodes = [
        ...
        helper.make_node("GreaterOrEqual", ["x", "dim0"], ["tensor_shape"]),
        helper.make_node("GreaterOrEqual", ["dim0", "x"], ["shape_tensor"]),
    ]
    graph = helper.make_graph(
        nodes, "greater_or_equal_shape_rank_lift", [x], [out1, out2], initializer=[idx]
    )
    ...
    onnx_name = "greater_or_equal_shape_rank_lift.onnx"
