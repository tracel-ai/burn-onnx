...
def main():
    ...
    inp_onnx__Pow_0 = helper.make_tensor_value_info("onnx::Pow_0", TensorProto.INT32, [1, 1, 1, 4])
    inp_onnx__Cast_1 = helper.make_tensor_value_info("onnx::Cast_1", TensorProto.INT64, [])
