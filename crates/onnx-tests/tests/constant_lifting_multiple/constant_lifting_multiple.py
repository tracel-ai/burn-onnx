...
def main():
    ...
    min_constant = helper.make_node(
        ...
        value=helper.make_tensor(
            name="min_tensor", data_type=TensorProto.FLOAT, dims=[], vals=[0.0]
        ),
        name="min_constant",
    )
    ...
    max_constant = helper.make_node(
        ...
        outputs=["max_value"],
        value=helper.make_tensor(
            name="max_tensor", data_type=TensorProto.FLOAT, dims=[], vals=[6.0]
        ),
        name="max_constant",
    )
    ...
    output_tensor = helper.make_tensor_value_info(
        "clipped_output", TensorProto.FLOAT, [2, 3]
    )
    ...
    print(
        "Generated constant_lifting_multiple.onnx - Clip node with multiple constants to lift"
    )
