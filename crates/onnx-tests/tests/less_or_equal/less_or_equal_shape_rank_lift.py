...
# used to generate model: onnx-tests/tests/less_or_equal/less_or_equal_shape_rank_lift.onnx
#
...
def main():
    ...
    nodes = [
        ...
        helper.make_node("LessOrEqual", ["x", "dim0"], ["tensor_shape"]),
        helper.make_node("LessOrEqual", ["dim0", "x"], ["shape_tensor"]),
    ]
    graph = helper.make_graph(
        nodes, "less_or_equal_shape_rank_lift", [x], [out1, out2], initializer=[idx]
    )
    ...
    onnx_name = "less_or_equal_shape_rank_lift.onnx"
