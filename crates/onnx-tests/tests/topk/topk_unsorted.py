...
# used to generate model: topk_unsorted.onnx
...
def main():
    ...
    node1 = helper.make_node(
        ...
        axis=1,
        largest=1,
        sorted=0,  # unsorted output allowed
    )
    ...
    onnx.save(model, "topk_unsorted.onnx")
    print(f"Finished exporting model to topk_unsorted.onnx")
