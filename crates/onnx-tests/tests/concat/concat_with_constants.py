...
def main():
    ...
    const1_node = helper.make_node(
        ...
        value=helper.make_tensor(
            name="const1_value", data_type=TensorProto.INT64, dims=[2], vals=[2, 3]
        ),
    )
    ...
    const2_node = helper.make_node(
        ...
        outputs=["const2"],
        value=helper.make_tensor(
            name="const2_value", data_type=TensorProto.INT64, dims=[1], vals=[5]
        ),
    )
    ...
    const3_node = helper.make_node(
        ...
        outputs=["const3"],
        value=helper.make_tensor(
            name="const3_value", data_type=TensorProto.INT64, dims=[3], vals=[7, 8, 9]
        ),
    )
