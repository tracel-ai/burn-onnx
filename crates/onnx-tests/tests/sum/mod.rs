...
mod tests {
    ...
    fn sum_tensor_and_tensor() {
        ...
        let model: sum::Model = sum::Model::default();

        let input1 = Tensor::<1>::from_floats([1., 2., 3., 4.], &device);
        let input2 = Tensor::<1>::from_floats([1., 2., 3., 4.], &device);
        let input3 = Tensor::<1>::from_floats([1., 2., 3., 4.], &device);
    ...
    fn sum_int_tensor_and_int_tensor() {
        let device = Default::default();
        let model: sum_int::Model = sum_int::Model::default();
        ...
        let input1 =
            Tensor::<1, Int>::from_data(TensorData::from([1i64, 2, 3, 4]), (&device, DType::I64));
        let input2 =
            Tensor::<1, Int>::from_data(TensorData::from([1i64, 2, 3, 4]), (&device, DType::I64));
        let input3 =
            Tensor::<1, Int>::from_data(TensorData::from([1i64, 2, 3, 4]), (&device, DType::I64));
