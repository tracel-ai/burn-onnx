...
def main():
    ...
    # ReduceMin, keepdims=0, axes=None (reduce all)
    node1 = helper.make_node("ReduceMin", ["x"], ["out1"], keepdims=0)
    out1 = helper.make_tensor_value_info("out1", TensorProto.FLOAT, [])

    # ReduceMin, keepdims=0, axes=[] (reduce all)
    node2 = helper.make_node("ReduceMin", ["x"], ["out2"], keepdims=0)
