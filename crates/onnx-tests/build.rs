...
fn add_all_inputs(model_gen: &mut ModelGen) {
    model_gen
        ...
        .input("tests/add/add_shape_broadcast.onnx")
        .input("tests/add/add_shape_rank_lift.onnx")
        ...
        .input("tests/and/and_shape_broadcast.onnx")
        ...
        .input("tests/attention/attention_kv_cache_causal.onnx")
        .input("tests/attention/attention_padding_mask_causal.onnx")
        .input("tests/attention/attention_softcap_bias.onnx")
        ...
        .input("tests/col2im/col2im_runtime.onnx")
        ...
        .input("tests/deform_conv/deform_conv_runtime_bias.onnx")
        .input("tests/depth_to_space/depth_to_space_crd.onnx")
        .input("tests/depth_to_space/depth_to_space_dcr.onnx")
        .input("tests/depth_to_space/depth_to_space_multi.onnx")
        .input("tests/depth_to_space/depth_to_space_int.onnx")
        ...
        .input("tests/div/div_shape_broadcast.onnx")
        .input("tests/div/div_shape_rank_lift.onnx")
        ...
        .input("tests/equal/equal_shape_broadcast.onnx")
        .input("tests/equal/equal_shape_rank_lift.onnx")
        ...
        .input("tests/expand/expand_shorter_shape.onnx")
        ...
        .input("tests/greater/greater_shape_broadcast.onnx")
        .input("tests/greater/greater_shape_rank_lift.onnx")
        ...
        .input("tests/greater_or_equal/greater_or_equal_shape_broadcast.onnx")
        .input("tests/greater_or_equal/greater_or_equal_shape_rank_lift.onnx")
        ...
        .input("tests/group_norm/group_norm_runtime_bias.onnx")
        ...
        .input("tests/instance_norm_runtime_bias/instance_norm_runtime_bias.onnx")
        ...
        .input("tests/layer_norm/layer_norm_broadcast.onnx")
        ...
        .input("tests/less/less_shape_broadcast.onnx")
        .input("tests/less/less_shape_rank_lift.onnx")
        ...
        .input("tests/less_or_equal/less_or_equal_shape_broadcast.onnx")
        .input("tests/less_or_equal/less_or_equal_shape_rank_lift.onnx")
        ...
        .input("tests/lp_pool1d/lp_pool1d_opset1.onnx")
        ...
        .input("tests/max/max_scalar.onnx")
        .input("tests/max/max_shape.onnx")
        ...
        .input("tests/maxpool/maxpool2d_indices_ceil.onnx")
        ...
        .input("tests/mod/mod_shape_broadcast.onnx")
        ...
        .input("tests/one_hot_encoder/one_hot_encoder_f32_large_cats.onnx")
        ...
        .input("tests/or/or_shape_broadcast.onnx")
        ...
        .input("tests/range/range_double_mixed.onnx")
        .input("tests/range/range_float_mixed.onnx")
        .input("tests/range/range_float_runtime.onnx")
        .input("tests/range/range_float_static.onnx")
        .input("tests/range/range_int16.onnx")
        .input("tests/range/range_int32_mixed.onnx")
        ...
        .input("tests/space_to_depth/space_to_depth_multi.onnx")
        .input("tests/space_to_depth/space_to_depth_int.onnx")
        ...
        .input("tests/sub/sub_shape_broadcast.onnx")
        .input("tests/sub/sub_shape_rank_lift.onnx")
        ...
        .input("tests/xor/xor_shape_broadcast.onnx")
        // If operator tests
