...
pub mod inception_v2 {
    include!(concat!(env!("OUT_DIR"), "/model/inception_v2.rs"));
}
...
fn main() {
    println!("========================================");
    println!("Inception v2 (BN-Inception) Burn Model Test");
    println!("========================================\n");

    let artifacts_dir = model_checks_common::artifacts_dir("inception-v2");
    ...
    println!("Initializing Inception v2 model...");
