...
pub mod densenet121 {
    include!(concat!(env!("OUT_DIR"), "/model/densenet121.rs"));
}
...
fn main() {
    println!("========================================");
    println!("DenseNet-121 Burn Model Test");
    println!("========================================\n");

    let artifacts_dir = model_checks_common::artifacts_dir("densenet121");
    ...
    println!("Initializing DenseNet-121 model...");
    let start = Instant::now();
    let device = model_checks_common::best_device!();
    let weights_path = concat!(env!("OUT_DIR"), "/model/densenet121.bpk");
    let model: densenet121::Model = densenet121::Model::from_file(weights_path, &device);
